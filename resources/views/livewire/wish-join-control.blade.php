...
>
    ...
    @if ($selfTransportShare)
        <section class="mt-3 overflow-hidden rounded-2xl border border-amber-100 bg-amber-50 text-sm">
            <div class="border-b border-amber-100 px-4 py-2.5 text-xs font-semibold text-amber-900">自由成團・單攻共乘</div>
